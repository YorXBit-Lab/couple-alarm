// import 'package:couple_note/core/services/filter_extension.dart';
// import 'package:couple_note/core/common/filter_model.dart';
// import 'package:couple_note/core/config/theme/colors.dart';
...
//     switch (pageType) {
//       case PageType.note:
//         return ref.watch(filterProvider(params));
//       case PageType.todo:
//         return ref.watch(filterProvider(params));
...
//     switch (pageType) {
//       case PageType.note:
//         return ref.read(filterProvider(params).notifier);
//       case PageType.todo:
//         return ref.read(filterProvider(params).notifier);
//       case PageType.reminder:
//         return ref.read(filterProvider(params).notifier);
