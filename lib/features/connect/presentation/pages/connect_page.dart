...
import 'package:couple_note/core/services/Admob/rewarded_ad_manager.dart';
...
class _CoupleConnectPageState extends ConsumerState<CoupleConnectPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: couple != null
          ? _buildConnectedView(couple, partner, currentUser, connectNotifier)
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<List<InvitationWithUser>>(
            stream: connectNotifier.getPendingInvitationsUseCase(
              currentUser!.uid,
            ),
