...
class UniversalFilterWidget extends ConsumerStatefulWidget {
  ...
  final FilterNotifier? externalFilterNotifier;
...
class _UniversalFilterWidgetState extends ConsumerState<UniversalFilterWidget> {
  ...
  void initState() {
    ...
    _filterNotifier = widget.externalFilterNotifier;
    ...
    if (_filterNotifier != null) {
      _filterNotifier!.addListener(_onExternalNotifierChanged);
    }
  }

  void _onExternalNotifierChanged(FilterState state) {
    if (mounted) {
      setState(() {
      ...
      return DraggableScrollableSheet(
        ...
        builder: (context, scrollController) {
          return UniversalFilterWidget(
            ...
            externalFilterNotifier: filterNotifier,
          );
        },
      );
    },
