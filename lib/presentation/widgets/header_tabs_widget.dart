...
import 'package:couple_note/providers/header_tabs_provider.dart';
import 'package:easy_localization/easy_localization.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class CoupleNoteHeaderTabs extends ConsumerStatefulWidget {
  final String title;
  ...
  @override
  ConsumerState<CoupleNoteHeaderTabs> createState() =>
      _CoupleNoteHeaderTabsState();
}

class _CoupleNoteHeaderTabsState extends ConsumerState<CoupleNoteHeaderTabs>
  ...
  @override
  void didUpdateWidget(CoupleNoteHeaderTabs oldWidget) {
    super.didUpdateWidget(oldWidget);

    // Update config if userTabs or currentUserTab changed
    ...
    // Update tab controller if currentUserTab changed externally
  ...
  void _onTabChanged() {
    if (_tabController.indexIsChanging) {
      ...
      // Update ViewModel
      ref
          .read(headerTabsViewModelProvider(_config).notifier)
          .changeUserTab(tabKey);
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(headerTabsViewModelProvider(_config));
