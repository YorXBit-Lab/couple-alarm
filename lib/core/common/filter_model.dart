...
enum PageType { reminder, general }
...
class FilterParams {
  ...
  const FilterParams({required this.pageType, this.userId, this.userTags});
  ...
  @override
  int get hashCode => Object.hash(pageType, userId, userTags);
}
